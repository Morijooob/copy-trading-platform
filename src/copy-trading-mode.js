...
export function buildExecutionPolicy({ mode = COPY_TRADING_MODES.DEMO, liveExecutionEnabled = false, exchangeAdapter = null } = {}) {
  ...
  if (mode !== COPY_TRADING_MODES.LIVE) {
    return Object.freeze({ mode, realMoney: false, exchangeRequired: false, exchangeAdapter: null });
  }
  ...
  return Object.freeze({ mode, realMoney: true, exchangeRequired: true, exchangeAdapter });
}
